...
SECRET_KEY = 'django-insecure-83wyqgk!#h+qvdue556=u!8ukp1ija$1asx-$_bf#g617*dch4'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Leave this empty if using app-level templates
        'APP_DIRS': True,  # This must be True to find app-level templates
        'OPTIONS': {
            'context_processors': [
